...
<body class="no-skin">
    ...
    <div id="zhongxin" style="padding-top: 13px;">
        <!-- ----------------------------- General Info Module ----------------------------------->
      <%@ include file="../../filetransfer/generalInfo_view.jsp"%>
 ...
 <fieldset id="ft-non-memory">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="radio">
                            <label ><input type="radio" class="ace" name="form-field-radio" id="form-field-radio1" onclick="setType('1');" <c:if test="${pd.isReadProgram == '1' }">checked="checked"</c:if>  disabled><span class="lbl">Program new release</span></label>
                            <label ><input type="radio" class="ace"  name="form-field-radio" id="form-field-radio2" onclick="setType('2');" <c:if test="${pd.isReadProgram == '2' }">checked="checked"</c:if>  disabled><span class="lbl">Program update</span></label>
             ...
             <div class="row"> 
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Tester Type</label>
                         <input type="text" name="testerType" class="form-control" placeholder="Tester Type"  value="${pd.testerType }" readonly/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="programNameFrom" class="form-control" placeholder="Program Name From" id="program-name-from" value="${pd.programNameFrom }" readonly />
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Program Name To</label>
                         <input type="text" name="programNameTo"  class="form-control" placeholder="Program Name To" id="ft-memory-program-to" value="${pd.programNameTo }" readonly/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="programSourcePath" class="form-control" placeholder="Program source path" id="program-source-path" value="${pd.programSourcePath }" readonly />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="required">Program destination path</label>
                         <input type="text" name="programDestinationPath" class="form-control" placeholder="Program destination path"  id="program-destination-path" value="${pd.programDestinationPath }" readonly />
                    </div>
                </div>
               ...
               <div class="col-md-4">
                    <div class="form-group">
                        <label>Old Version Program Path</label>
                         <input type="text" name="oldVersionProgramPath"  class="form-control" placeholder="Old Version Program Path" id="ft-memory-old-path" value="${pd.oldVersionProgramPath }" readonly />
               ...
               <div class="col-md-4">
                    <div class="form-group">
                        <label>Setup file Source path</label>
                          <input type="text" name="setupFileSourcePath" class="form-control" placeholder="Setup file Source path" value="${pd.setupFileSourcePath }" readonly />
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Setup file destination path</label>
                          <input type="text" name="setupFileDestinationPath" class="form-control" placeholder="Setup file destination path" value="${pd.setupFileDestinationPath }" readonly />
                    </div>
                </div>             
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Auto Delete</label>
                         <select class="form-control" name="autoDelete" disabled>
                            <option value="0" <c:if test="${pd.autoDelete == '0' }">selected</c:if>>Disable</option>
                            <option value="1" <c:if test="${pd.autoDelete == '1' }">selected</c:if>>Immediately</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="submit-button-container">
	        <div class="submit-button">
	            <a class="btn btn-lg btn-success" onclick="appval();">批准</a>
	        </div>
	        <div class="submit-button">
	            <a class="btn btn-lg btn-danger" onclick="deny();">拒绝</a>
	        </div>
        </div>
        <!-- 返回顶部 -->
