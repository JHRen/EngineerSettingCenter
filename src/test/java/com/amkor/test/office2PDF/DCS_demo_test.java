	...
	/**
	    ...
	    */
	    ...
	    public static void main(String[] args) {
	        ...
	        // 文件上传转换
	        String convertByFile = SubmitPost("http://dcs.yozosoft.com:80/upload", "D:\\aaa\\OPL_Eng'r+hand+carry+units+out+of+company+without+approval.pptx", "1");
	        // 网络地址转换
	        //String convertByUrl  = sendPost("http://dcs.yozosoft.com:80/onlinefile", "downloadUrl=http://img.iyocloud.com:8000/doctest.docx&convertType=1");
