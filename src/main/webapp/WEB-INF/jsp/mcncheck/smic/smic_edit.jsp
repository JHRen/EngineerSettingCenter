		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="mcncheck/smic/${msg}.do" name="editForm" id="editForm" method="post">
									...
									<input type="hidden" name="MCN_check" id="MCN_check" value="${pd.MCN}"/>
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">MCN:</td>
											<td><input type="text" name="MCN" id="MCN" value="${pd.MCN}" maxlength="60"  title="Cust_Code" style="width:98%;"/></td>
										</tr>
...
<script type="text/javascript">
	...
	function save(){
		...
		return false;
			...
			if(($("#TargetDevice").val()!=$("#TargetDevice_check").val())||($("#TargetDevice_check").val()=="")){
				hasData();
			}else{
				$("#editForm").submit();
				$("#zhongxin").hide();
	...
	function hasData(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>mcncheck/smic/hasData.do',
