			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
<!-- 检索  -->
<form action="mcncheck/gf/list.do" method="post" name="Form" id="Form">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center' style="vertical-align: middle;">${var.MCN_Name}</td>
										    <td class='center' style="vertical-align: middle;">${var.GF_Part}</td>
										    <td class='center' style="vertical-align: middle;">${var.TEST_PGM1}</td>
											<td class='center' style="vertical-align: middle;">${var.JOB_NAME}</td>												
											<!-- 操作按钮start -->
					...
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;">
								...
								<c:if test="${QX.apr == 1 }">
										<a class="btn btn-mini btn-warning" onclick="window.location.href='<%=basePath%>mcncheck/gf/list.do?type=2';">切换审批视图</a>
								</c:if>
							</td>
