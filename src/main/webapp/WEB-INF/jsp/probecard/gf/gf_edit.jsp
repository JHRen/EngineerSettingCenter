		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="probecard/gf/${msg}.do" name="editForm" id="editForm" method="post">
								...
								<div id="zhongxin" style="padding-top: 13px;">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<tr>
											...
											<td><input type="text" name="Cust_Tool_Name"id="Cust_Tool_Name" value="${pd.Cust_Tool_Name }"maxlength="60" title="Cust_Tool_Name" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td style="width: 79px; text-align: right; padding-top: 13px;">Tool&nbsp;Name:</td>
											<td><input type="text" name="Tool_Name" id="Tool_Name" value="${pd.Tool_Name }" maxlength="60" title="Tool_Name"style="width: 98%;" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" name="Touchdown_Per_Wafer" id="Touchdown_Per_Wafer" value="${pd.Touchdown_Per_Wafer}"maxlength="60" title="Touchdown_Per_Wafer" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td style="width: 79px; text-align: right; padding-top: 13px;">Touchdown&nbsp;Limit:</td>
											<td><input type="text" name="Touchdown_Limit" id="Touchdown_Limit" value="${pd.Touchdown_Limit}"maxlength="60" title="Touchdown_Limit" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td style="width: 79px; text-align: right; padding-top: 13px;">Gross Die Per Wafer:</td>
											<td><input type="text" name="Gross_Die_Per_Wafer"id="Gross_Die_Per_Wafer" value="${pd.Gross_Die_Per_Wafer}"maxlength="60" title="Gross Die Per Wafer" style="width: 98%;" /></td>
										</tr>
...
<script type="text/javascript">
	...
	function hasData(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>probecard/gf/hasData.do',
			data : {
				Cust_Tool_Name : Cust_Tool_Name,
