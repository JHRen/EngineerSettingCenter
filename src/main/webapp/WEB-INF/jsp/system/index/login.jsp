...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<!-- <span class="pull-left" style="padding-right:3%;"><a href="javascript:changepage(3);" class="btn btn-success">更新公告</a></span> -->
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 2025 安靠封装测试(上海)有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright &copy; 2018 安靠封装测试(上海)有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
				<form action="" method="post" name="loginForm" id="loginForm">
					...
					<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(2);" class="btn btn-success">确认</a></span>
				</form>
		</div>
		</div>
	</div>
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.result){
							...
							showfh();
							$("#code").focus();
						}else if("quanxianerror"==data.result){
							$("#loginname").tips({
								side : 1,
								msg : "账号没有权限，请将windows登陆账号发送TEST-IT申请权限",
								bg : '#FF5080',
								time : 15
							});
							showfh();
