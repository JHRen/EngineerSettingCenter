									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="email" name="EMAIL" id="EMAIL"  value="${pd.EMAIL }" maxlength="32" title="邮箱" onblur="hasE('${pd.USERNAME }')" style="width:98%;" disabled="disabled"/></td>
																...
																<tr id="zt">
											<td style="width:79px;text-align: right;padding-top: 13px;">管理员 : </td>
											<td>
											<label style="float:left;padding-left: 8px;padding-top:7px;">
											<input name="form-field-status" type="radio" class="ace" id="form-field-status0" <c:if test="${pd.ADMIN == 0 }">checked="checked"</c:if> />
											　　　<span class="lbl"> 是</span>
											</label>
											<label style="float:left;padding-left: 5px;padding-top:7px;">
												<input name="form-field-status" type="radio" class="ace" id="form-field-status1" <c:if test="${pd.ADMIN == 1 }">checked="checked"</c:if> />
