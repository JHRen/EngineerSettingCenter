					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;width: 170px;">
								 	<select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="请选择角色" style="vertical-align:top;width: 170px;">
									<option value=""></option>
								 ...
								 <td style="vertical-align:top;padding-left:2px">
                                    <select name="DEPARTMENT_ID" id="DEPARTMENT_ID"  title="请选择部门" style="width:125px;">
                                    </select>
                                </td>
