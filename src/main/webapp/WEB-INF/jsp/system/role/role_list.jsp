							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="margin-top:7px;">
								...
								<c:choose>
									<c:when test="${not empty roleList_z}">
										...
										<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','apr_qx');" class="btn btn-warning btn-mini" title="分配查看权限"><i class="ace-icon fa fa-wrench bigger-110 icon-only"></i></a></td>
										</c:if>
