			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="file"   name="attachedTestResult" id="uploadifive1" keepDefaultStyle = "true"/>
				...
				<div class="col-md-4">
					<div class="form-group">
					    ...
					    <input type="file"  name="attachCustomerApproval" id="uploadifive2" keepDefaultStyle = "true"/>
