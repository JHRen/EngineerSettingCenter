									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'  style=" text-overflow: ellipsis; white-space:nowrap; overflow:hidden; width:250px;" data-formatter="FirstFormatter">
                                                ...
                                                <c:if test="${var.fileType == 'yasuo'}"> ${var.NAME}${fn:substring(var.FILEPATH ,19,fn:length(var.FILEPATH))}</c:if>
	...
	<script type="text/javascript">
       ...
       /*  $(function () { $("[data-toggle='tooltip']").tooltip(); }); */
		...
		function goViewPdf(fileName,Id){
	      ...
	      function goViewPpt(fileName,Id){
	            var diag = new top.Dialog();
	            diag.Drag=true;
	            diag.Title =fileName;
	            diag.URL = '<%=basePath%>assemblyfile/goViewPpt.do?FILE_ID='+Id;
	            diag.Modal = false;             //有无遮罩窗口
