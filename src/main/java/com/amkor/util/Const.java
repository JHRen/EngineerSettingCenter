...
public class Const {
	...
	public static final String SESSION_ROLE_PARENTID = "ROLE_PARENTID"; // 用户权限父ID
	...
	public static final String SESSION_FILE = "FILE_FLAG";                  //文件第一次打开的开关
	public static final String TRUE = "T";
	public static final String FALSE = "F";
	public static final String SKIN = "SKIN";								//用户皮肤
	public static final String LOGIN = "/login_toLogin.do";					//登录地址
	public static final String WEB_ESUMMARY = "/esummary/list.do";			//esummary web地址
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(plugins)|(main)|(websocket)|(uploadImgs)|(esummary)|(esummary/*)|(download)).*";	//不对匹配该值的访问路径拦截（正则）
	public static ApplicationContext WEB_APP_CONTEXT = null; //该值会在web容器启动时由WebAppContextListener初始化
	public static final String EMAILRECIPIENT="allEmaliRecipient";  //当前用户组接受邮件的人
	public static final String EMAILTO_TEST = "admin/config/EMAILTO_TEST.txt";
	public static final String EMAILTO_ASSY = "admin/config/EMAILTO_ASSY.txt";
	/**
	 * APP Constants
	 */
	//系统用户注册接口_请求协议参数)
