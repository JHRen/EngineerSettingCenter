package com.amkor.controller.system.tools;
...
import com.amkor.util.Freemarker;
import com.amkor.util.ImageAnd64Binary;
import com.amkor.util.Jurisdiction;
import com.amkor.util.MapDistance;
import com.amkor.util.PageData;
import com.amkor.util.PathUtil;
import com.amkor.util.Tools;
import com.amkor.util.TwoDimensionCode;
import com.amkor.util.express.GetExpressMsg;
...
public class ToolController extends BaseController {
	...
	public ModelAndView video() throws Exception{
		...
		pd.put("userPhoto", null == pdPhoto?"static/ace/avatars/user.png":pdPhoto.getString("PHOTO3"));//用户头像
