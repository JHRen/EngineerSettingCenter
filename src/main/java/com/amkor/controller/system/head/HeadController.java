package com.amkor.controller.system.head;
...
public class HeadController extends BaseController {
	...
	public Object getList() {
		...
		try {
			...
			map.put("userPhoto", null == pdPhoto?"static/ace/avatars/user.png":pdPhoto.getString("PHOTO2"));//用户头像
	...
	public ModelAndView goEditEmail() throws Exception{
		if(!"40607".equals(Jurisdiction.getUsername())){return null;}	//非管理员用户不能修改
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
	...
	public ModelAndView saveSys() throws Exception{
		if(!"40607".equals(Jurisdiction.getUsername())){return null;}	//非40607用户不能修改
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
