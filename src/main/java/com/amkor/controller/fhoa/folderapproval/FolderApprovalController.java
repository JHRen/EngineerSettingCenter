package com.amkor.controller.fhoa.folderapproval;
...
@Controller
@RequestMapping(value="folderapproval")
public class FolderApprovalController extends BaseController{
	...
	public ModelAndView listCP(Page page) throws Exception{	
		...
		mv.setViewName("fhoa/folder/folder_approval");
