package com.amkor.service.system.role.impl;
...
public class RoleService implements RoleManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Role> listUserAllRolesByPId(PageData pd) throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listUserAllRolesByPId", pd);
	}
